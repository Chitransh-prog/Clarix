...
import { Zap, Download, Copy, Check, ChevronRight, ExternalLink } from "lucide-react";
...
|---------|-------|------|--------|
| UI/UX Design | 20hrs | Rs.2,000/hr | Rs.40,000 |
| Next.js Dev | 40hrs | Rs.2,500/hr | Rs.1,00,000 |
| Supabase Backend | 15hrs | Rs.2,000/hr | Rs.30,000 |

**Subtotal:** Rs.1,70,000
**GST (18%):** Rs.30,600
**Total Due: Rs.2,00,600**
...
The Agency agrees to design and develop a full-stack
web application including UI/UX design, frontend
development using Next.js, and backend with Supabase.
...
We are thrilled to have you on board! This document
outlines everything you need to know about working
with us on your project.

---

## Your Dedicated Team

- Chitransh Prasad — Project Lead
...
information, oral or written, disclosed by the
Client that is designated as confidential or that
...
**Agreed Timeline:** 8 weeks from kickoff
**Project Value:** Rs.2,00,600
  ...
  return (
    <section id="docs-generator" className="py-28 px-5 border-t border-obsidian-800/60">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-base text-obsidian-400 leading-relaxed mb-6">
              Stop spending hours writing invoices, contracts, and welcome docs
              from scratch. Clarix generates professional, ready-to-send
              documents tailored to each client project instantly.
            </p>
            ...
            <div className="flex flex-col gap-2.5">
              <div className="flex items-center gap-3 p-3.5 rounded-xl bg-obsidian-900/60 border border-obsidian-800">
                ...
                <div>
                  <p className="text-xs font-medium text-obsidian-200">
                    6,000 free tokens daily
                  </p>
                  <p className="text-[11px] text-obsidian-500">
                    Resets every midnight · No card needed
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3.5 rounded-xl bg-obsidian-900/60 border border-obsidian-800">
                ...
                <div className="flex-1">
                  <p className="text-xs font-medium text-obsidian-200">
                    Need more? Support the project
                  </p>
                  <p className="text-[11px] text-obsidian-500">
                    Donate to unlock up to 50K tokens/day
                  </p>
                </div>
                <a
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-2xl bg-obsidian-900/80 border border-obsidian-800 overflow-hidden shadow-2xl">
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-obsidian-900 border-b border-obsidian-800">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span className="text-base">{activeDoc.icon}</span>
                    <span className="text-xs text-obsidian-400 font-medium">
                      {activeDoc.label}
                    </span>
                    {isTyping && (
                ...
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 6px ${activeDoc.color}`,
                    }}
                  />
                  <button
                    onClick={copyPreview}
                    className="flex items-center gap-1 text-[11px] text-obsidian-500 hover:text-obsidian-200 transition-colors"
                  >
                    {copied ? (
                      <>
              ...
              {/* Footer */}
              <div className="px-4 py-2.5 border-t border-obsidian-800 bg-obsidian-950/60 flex items-center justify-between">
                <div className="flex items-center gap-3">
        ...
        {/* CTA strip */}
        <div className="relative rounded-2xl overflow-hidden border border-indigo-500/20 bg-indigo-600/5 p-8 flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
          <div
            aria-hidden
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-obsidian-400">
              Add a client project and hit generate — professional docs in under
              10 seconds.
            </p>
          </div>
          ...
          {[
            {
              step: "01",
              title: "Add project",
              desc: "Fill in client details, tech stack, budget and timeline",
            },
            {
              step: "02",
              title: "Pick a doc",
              desc: "Choose from Invoice, Contract, NDA, Welcome or Acknowledgement",
            },
            {
              step: "03",
              title: "AI generates",
              desc: "Gemini writes a fully professional, tailored document instantly",
            },
            {
              step: "04",
              title: "Send to client",
              desc: "Copy, download as Markdown, or paste into Google Docs or Notion",
            },
          ].map((s) => (
            <div
              key={s.step}
              className="flex flex-col gap-3 p-4 rounded-2xl bg-obsidian-900/40 border border-obsidian-800"
            >
              <span className="text-lg font-bold text-obsidian-700 font-mono">
                {s.step}
              </span>
              <div>
                <p className="text-sm font-medium text-obsidian-100 mb-1">
                  {s.title}
                </p>
